...
export const RECIPE_DATA = {
    title: "Dumplings",
    imgSrc: DUMPLINGS,
    imgAlt: "pan fried dumplings",
    description: "A recipe for making simple dumplings in just a few steps",
    ingredients: [
        { measure: "3 lbs", item: "green leafy vegetables" },
        { measure: "1 ½ pounds", item: "ground pork" },
        { measure: "2/3 cup", item: "shaoxing wine (or dry cooking sherry)" },
        { measure: "½ cup", item: "neutral oil (such as canola, vegetable, or avocado oil)" },
        { measure: "3 tablespoons", item: "sesame oil" },
        { measure: "1 tablespoon", item: "salt" },
        { measure: "3 tablespoons", item: "soy sauce" },
        { measure: "¼ teaspoon", item: "white pepper" },
        { measure: "2/3 cup", item: "water (plus more for assembly)" },
        { measure: "3 packages", item: "dumpling wrappers" }
    ],
    instructions: [
